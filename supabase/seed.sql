...
INSERT INTO portfolio.skill_categories (name, description, display_order)
VALUES (
    'Frontend Development',
    'Skills related to client-side web development',
    1
  ),
  (
    'Backend Development',
    'Skills related to server-side development',
    2
  ),
  ('Design', 'UI/UX and graphic design skills', 3),
  (
    'DevOps',
    'Skills related to deployment and operations',
    4
  );
...
VALUES (
    'React',
    'Building interactive UIs with React and its ecosystem',
    (
      SELECT id
  ...
  (
    'TypeScript',
    'Strongly typed programming for JavaScript',
    (
      SELECT id
      FROM portfolio.skill_categories
      WHERE name = 'Frontend Development'
...
-- Insert soft skills
INSERT INTO portfolio.skills (name, description, level, type, display_order)
VALUES (
    'Communication',
  ...
  (
    'Adaptability',
    'Quickly learning new technologies and adjusting to changes',
    5,
    'soft',
    5
  );
...
-- Insert education (Fixed escaping of single quotes)
...
-- Insert interests
INSERT INTO portfolio.interests (name, description, display_order)
VALUES (
    'Open Source',
  ...
  (
    'AI & Machine Learning',
    'Exploring applications of AI in web development',
    2
  ),
  (
    'Photography',
    'Capturing landscapes and urban environments',
    3
  ),
  (
    'Hiking',
  ...
  (
    'Reading',
    'Science fiction and technical books',
    5
  );
-- Insert project categories
INSERT INTO portfolio.project_categories (name, description, slug, display_order)
VALUES (
    'Web Applications',
...
-- Insert projects (Fixed escaping of single quotes in content)
...
VALUES (
    ...
    'This e-commerce platform transformed our online business. Sales increased by 45% in Aqthe first quarter after launch, and the admin tools save us hours of work every week.',
    5,
    1
  ),
  (
...
INSERT INTO portfolio.blog_categories (name, description, slug, display_order)
VALUES (
    'Web Development',
    'Articles about web development technologies and practices',
    'web-development',
    1
  ),
  (
    'UI/UX Design',
    'Insights on user interface and experience design',
    'ui-ux-design',
    2
  ),
  (
    'Career Advice',
    'Tips and advice for tech professionals',
    'career-advice',
    3
  ),
  (
    'Technology Trends',
    'Analysis of emerging technologies and industry trends',
    'technology-trends',
    4
  );
-- Insert blog tags
INSERT INTO portfolio.blog_tags (name, slug)
VALUES ('React', 'react'),
...
-- Insert social links
INSERT INTO portfolio.social_links (platform, url, display_order, is_featured)
VALUES ('GitHub', 'https://github.com/johndoe', 1, TRUE),
  (
    'LinkedIn',
...
INSERT INTO portfolio.navigation_items (label, url, display_order, is_external)
VALUES ('Home', '/', 1, FALSE),
  ('About', '/about', 2, FALSE),
...
-- Insert settings
INSERT INTO portfolio.settings (key, value, description)
VALUES (
    'site_settings',
...
-- Insert SEO settings (Fixed escaping of single quotes)
...
-- Insert AI prompts (Fixed escaping of single quotes)
