...
const ProjectsPage: React.FC = () => {
  ...
  const handleViewChange = (
    ...
    if (newView === "form" && projectId) {
      ...
      // Always navigate to the projects list when switching to list view
        ...
        >
          ...
          <div className="mt-4 sm:mt-0 flex space-x-3">
            ...
            <Button
              variant={
                view === "form" &&
                (window.location.pathname.endsWith("/new") || !id)
                  ? "primary"
                  : "secondary"
              }
          ...
          {view === "list" && (
            <ProjectsList
              ...
              onEdit={(projectId: string) =>
                handleViewChange("form", projectId)
              }
