...
const ProjectCategoriesList: React.FC<ProjectCategoriesListProps> = ({
  categories,
  isLoading,
  onBack,
}) => {
  ...
  const [formData, setFormData] = useState<Omit<ProjectCategory, 'id' | 'created_at' | 'updated_at'>>({
    name: '',
    description: '',
    slug: '',
    icon: '',
  ...
  const saveCategoryMutation = useMutation({
    mutationFn: async (data: { id?: string; category: Omit<ProjectCategory, 'id' | 'created_at' | 'updated_at'> }) => {
      if (data.id) {
      ...
      <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden">
        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Manage categories for organizing your projects
          </p>
        </div>
