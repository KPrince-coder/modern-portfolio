      ...
      <div className={`py-20 ${isLoading ? "hidden" : ""}`}>
        ...
        >
          ...
          <div className="space-y-8">
            {(workExperience || sampleWorkExperience).map(
              (experience, index) => (
                <ExperienceItem
                  // @ts-ignore
...
const sampleSoftSkills = [
  {
    name: "Communication",
    description:
      "Effectively conveying ideas and information to team members, stakeholders, and clients.",
    icon: (
      <svg
        className="w-10 h-10"
        fill="currentColor"
  ...
  },
  {
    ...
    description:
      "Analyzing complex issues and developing innovative solutions to technical challenges.",
    icon: (
      <svg
        className="w-10 h-10"
        fill="currentColor"
  ...
  },
  {
    ...
    description:
      "Prioritizing tasks and managing deadlines to deliver projects efficiently.",
    icon: (
      <svg
        className="w-10 h-10"
        fill="currentColor"
  ...
  },
  {
    name: "Leadership",
    description:
      "Guiding and motivating team members to achieve their best work and meet project objectives.",
    icon: (
      <svg
        className="w-10 h-10"
        fill="currentColor"
...
const sampleWorkExperience = [
  {
    ...
    endDate: "Present",
    description:
      "Leading the frontend development team in building modern, responsive web applications using React, TypeScript, and Tailwind CSS.",
    achievements: [
  ...
  },
  {
    ...
    description:
      "Developed and maintained web applications for clients in various industries, focusing on responsive design and cross-browser compatibility.",
    achievements: [
